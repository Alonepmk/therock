...
class UdBmr extends StatefulWidget {
  final GymUser gymUser;
  final String bmrLink;
  final String date;
  const UdBmr(
      {Key? key,
      required this.gymUser,
      required this.bmrLink,
      required this.date})
      : super(key: key);

  @override
  State<UdBmr> createState() => _UdBmrState();
}

class _UdBmrState extends State<UdBmr> {
  ...
  void initState() {
    super.initState();
    bmrPicLinkController.text = widget.bmrLink;
    date = widget.date;
    month = widget.date.split(" ")[0];
    year = widget.date.split(" ")[1];
  }
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        if (bmrPicLinkController.text != "" && date != "Date") {
                          ...
                          scaffoldUtil(
                              context, "Data Successfully Updated!", 1);
